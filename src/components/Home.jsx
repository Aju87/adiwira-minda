const FEATURES = [
  ...
  { icon: '🌱', text: '3 Peringkat Umur',         bg: '#5352ED', shadow: '#2C2BAA' },
...
export default function Home({ totalStars, onStart }) {
  return (
    <div className="hero-wrap">
      ...
      {/* Hero character */}
      <div className="hero-character" role="img" aria-label="Adiwira">🦸</div>
      ...
      {totalStars > 0 && (
        <div style={{
          ...
          ⭐ Jumlah Bintang Kamu: <strong>{totalStars.toLocaleString()}</strong>
        </div>
      )}
